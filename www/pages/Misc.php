...
if($GLOBALS['page']['slug'] == 'About') { ob_start(); ?>
    ...
    <p>As you've probably noticed this website relies heavily on JavaScript and especially AJAX, so if your browser is out of date you might experience several issues while browsing the site.
    On the other hand, I'm trying my best to maintain browser compatibility at a reasonable level (without sacrificing any of the cool features) so hopefully your browsing experience will be smooth as silk.
    If you're interested in the code behind kuzhagaliyev.kz, whether it is front-end or back-end, you can find the source code on GitHub. More about it on the <a href="http://kuzhagaliyev.kz/Development/" class="load-page">development page</a>.</p>

<? }

if($GLOBALS['page']['slug'] == 'Development') { ob_start(); ?>
